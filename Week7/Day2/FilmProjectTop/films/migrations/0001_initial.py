    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release_date', models.DateField(default=datetime.date(2023, 4, 30))),
                ('available_in_countries', models.ManyToManyField(related_name='available_films', to='films.country')),
